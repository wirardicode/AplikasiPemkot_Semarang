...
cred = credentials.Certificate(r"sadk.json")
...
def save_to_firestore(data):
    try:
        # Menyimpan data ke Firestore ke koleksi "ocr_result"
...
#berdasar isi dokumen dari tiap dokumen (kasus ini mencari pake judul arsip)
